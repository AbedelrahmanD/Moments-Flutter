...
class MMPeopleMomentJoin extends StatelessWidget {
  ...
  final String people;
  final bool canJoin;
  const MMPeopleMomentJoin({Key? key, required this.username, required this.momentName, required this.time, required this.location, required this.people, required this.type, required this.canJoin}) : super(key: key);
