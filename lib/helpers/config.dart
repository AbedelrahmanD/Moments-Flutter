...
const double cmTextFieldBorderRadius = 12;
const double cmTextFieldWidth = 300;
const double cmTextFieldHeight = 50;
const double cmTextFieldMarginTop = 5;
const double cmTextFieldMarginBottom = 5;
...
const double cmButtonBorderRadius = 12;
